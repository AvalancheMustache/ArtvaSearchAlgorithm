 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Sat Aug 30 12:01:50 2014
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Rot_B2G
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void Rot_B2G_Outputs_wrapper(const real_T *angles,
			real_T *rot);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    Rot_B2G_Outputs_wrapper(angles, rot);
