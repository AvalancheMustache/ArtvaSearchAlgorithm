 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Sat Aug 30 12:01:49 2014
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME hexacopter_s
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define NUM_CONT_STATES      12
#define CONT_STATES_IC       [3,3,4,2,2,2,.6,.6,1.5,0,0,0,0]
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    hexacopter_s_Outputs_wrapper(y, xC);
...
/* Function: mdlDerivatives =================================================
  ...
  static void mdlDerivatives(SimStruct *S)
  {
    ...
    const real_T   *p  = (const real_T*) ssGetInputPortSignal(S,1);
    real_T         *dx  = ssGetdX(S);
    real_T         *xC  = ssGetContStates(S);
    real_T        *y  = (real_T *) ssGetOutputPortRealSignal(S,0);

    hexacopter_s_Derivatives_wrapper(u, p, y,dx,  xC);
}
