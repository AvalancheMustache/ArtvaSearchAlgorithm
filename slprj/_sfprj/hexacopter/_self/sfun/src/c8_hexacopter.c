...
static const char * c8_debug_family_names[14] = { "d", "dist", "h", "rho", "i",
  "didi", "j", "nargin", "nargout", "x_obst", "x_drone", "R_G2B", "parameter",
  "dist_out" };
...
static void sf_gateway_c8_hexacopter(SFc8_hexacopterInstanceStruct
  *chartInstance);
static void c8_chartstep_c8_hexacopter(SFc8_hexacopterInstanceStruct
  *chartInstance);
...
static void c8_emlrt_marshallIn(SFc8_hexacopterInstanceStruct *chartInstance,
  const mxArray *c8_dist_out, const char_T *c8_identifier, real_T c8_y[6]);
...
static const mxArray *c8_f_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real_T c8_c_emlrt_marshallIn(SFc8_hexacopterInstanceStruct *chartInstance,
...
static const mxArray *c8_g_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_d_emlrt_marshallIn(SFc8_hexacopterInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[7986]);
static void c8_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static void c8_e_emlrt_marshallIn(SFc8_hexacopterInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[3993]);
...
static void c8_eml_scalar_eg(SFc8_hexacopterInstanceStruct *chartInstance);
static void c8_eml_xgemm(SFc8_hexacopterInstanceStruct *chartInstance, real_T
  c8_A[9], real_T c8_B[3], real_T c8_C[3], real_T c8_b_C[3]);
static void c8_scalarEg(SFc8_hexacopterInstanceStruct *chartInstance);
static real_T c8_eml_xdotu(SFc8_hexacopterInstanceStruct *chartInstance, real_T
  c8_x[3], real_T c8_y[3]);
static real_T c8_mpower(SFc8_hexacopterInstanceStruct *chartInstance, real_T
  c8_a);
static void c8_b_eml_scalar_eg(SFc8_hexacopterInstanceStruct *chartInstance);
static void c8_check_forloop_overflow_error(SFc8_hexacopterInstanceStruct
  *chartInstance, boolean_T c8_overflow);
static const mxArray *c8_h_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_f_emlrt_marshallIn(SFc8_hexacopterInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_g_emlrt_marshallIn(SFc8_hexacopterInstanceStruct
  *chartInstance, const mxArray *c8_b_is_active_c8_hexacopter, const char_T
  *c8_identifier);
static uint8_T c8_h_emlrt_marshallIn(SFc8_hexacopterInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_eml_xgemm(SFc8_hexacopterInstanceStruct *chartInstance, real_T
  c8_A[9], real_T c8_B[3], real_T c8_C[3]);
  ...
  *chartInstance, const mxArray *c8_st)
{
  ...
  chartInstance->c8_is_active_c8_hexacopter = c8_g_emlrt_marshallIn
  ...
  *chartInstance)
{
  ...
  int32_T c8_i5;
  int32_T c8_i6;
  real_T (*c8_parameter)[2];
  real_T (*c8_R_G2B)[9];
  real_T (*c8_x_drone)[3];
  real_T (*c8_dist_out)[6];
  real_T (*c8_x_obst)[3993];
  c8_parameter = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 3);
  ...
  for (c8_i2 = 0; c8_i2 < 3993; c8_i2++) {
    _SFD_DATA_RANGE_CHECK((*c8_x_obst)[c8_i2], 0U);
  }

  chartInstance->c8_sfEvent = CALL_EVENT;
  c8_chartstep_c8_hexacopter(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_hexacopterMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c8_i3 = 0; c8_i3 < 6; c8_i3++) {
    _SFD_DATA_RANGE_CHECK((*c8_dist_out)[c8_i3], 1U);
  }

  for (c8_i4 = 0; c8_i4 < 3; c8_i4++) {
    _SFD_DATA_RANGE_CHECK((*c8_x_drone)[c8_i4], 2U);
  }

  for (c8_i5 = 0; c8_i5 < 9; c8_i5++) {
    _SFD_DATA_RANGE_CHECK((*c8_R_G2B)[c8_i5], 3U);
  }

  for (c8_i6 = 0; c8_i6 < 2; c8_i6++) {
    _SFD_DATA_RANGE_CHECK((*c8_parameter)[c8_i6], 4U);
  }
}
  ...
  *chartInstance)
{
  ...
  real_T (*c8_b_parameter)[2];
  real_T (*c8_b_R_G2B)[9];
  real_T (*c8_b_x_drone)[3];
  real_T (*c8_b_x_obst)[3993];
  boolean_T exitg1;
  c8_b_parameter = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 3);
  ...
  for (c8_i7 = 0; c8_i7 < 3993; c8_i7++) {
    c8_x_obst[c8_i7] = (*c8_b_x_obst)[c8_i7];
  }

  for (c8_i8 = 0; c8_i8 < 3; c8_i8++) {
    c8_x_drone[c8_i8] = (*c8_b_x_drone)[c8_i8];
  }

  for (c8_i9 = 0; c8_i9 < 9; c8_i9++) {
    c8_R_G2B[c8_i9] = (*c8_b_R_G2B)[c8_i9];
  }

  for (c8_i10 = 0; c8_i10 < 2; c8_i10++) {
    c8_parameter[c8_i10] = (*c8_b_parameter)[c8_i10];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 14U, 14U, c8_debug_family_names,
    c8_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c8_d, 0U, c8_e_sf_marshallOut,
    c8_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c8_dist, 1U, c8_g_sf_marshallOut,
    c8_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_h, 2U, c8_f_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_rho, 3U, c8_f_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_i, 4U, c8_f_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_didi, 5U, c8_f_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_j, 6U, c8_f_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargin, 7U, c8_f_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 8U, c8_f_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c8_x_obst, 9U, c8_e_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c8_x_drone, 10U, c8_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c8_R_G2B, 11U, c8_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c8_parameter, 12U, c8_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c8_dist_out, 13U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 2);
  for (c8_i11 = 0; c8_i11 < 6; c8_i11++) {
    c8_dist_out[c8_i11] = 0.0;
  }

  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 3);
  for (c8_i12 = 0; c8_i12 < 3993; c8_i12++) {
    c8_d[c8_i12] = 0.0;
  }

  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 4);
  for (c8_i13 = 0; c8_i13 < 7986; c8_i13++) {
    c8_dist[c8_i13] = 0.0;
  }
  ...
  while (c8_b_i < 1331) {
    ...
    for (c8_i14 = 0; c8_i14 < 9; c8_i14++) {
      c8_a[c8_i14] = c8_R_G2B[c8_i14];
    }

    c8_c_i = _SFD_EML_ARRAY_BOUNDS_CHECK("x_obst", (int32_T)_SFD_INTEGER_CHECK(
      "i", c8_i), 1, 1331, 2, 0) - 1;
    for (c8_i15 = 0; c8_i15 < 3; c8_i15++) {
      c8_b[c8_i15] = c8_x_obst[c8_i15 + 3 * c8_c_i] - c8_x_drone[c8_i15];
    }
    ...
    for (c8_i17 = 0; c8_i17 < 9; c8_i17++) {
      c8_b_a[c8_i17] = c8_a[c8_i17];
    }

    for (c8_i18 = 0; c8_i18 < 3; c8_i18++) {
      c8_b_b[c8_i18] = c8_b[c8_i18];
    }

    c8_b_eml_xgemm(chartInstance, c8_b_a, c8_b_b, c8_y);
    c8_d_i = _SFD_EML_ARRAY_BOUNDS_CHECK("d", (int32_T)_SFD_INTEGER_CHECK("i",
      c8_i), 1, 1331, 2, 0) - 1;
    for (c8_i19 = 0; c8_i19 < 3; c8_i19++) {
      c8_d[c8_i19 + 3 * c8_d_i] = c8_y[c8_i19];
    }

    _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 10);
    c8_e_i = _SFD_EML_ARRAY_BOUNDS_CHECK("d", (int32_T)_SFD_INTEGER_CHECK("i",
      c8_i), 1, 1331, 2, 0) - 1;
    for (c8_i20 = 0; c8_i20 < 3; c8_i20++) {
      c8_c_a[c8_i20] = c8_d[c8_i20 + 3 * c8_e_i];
    }

    c8_f_i = _SFD_EML_ARRAY_BOUNDS_CHECK("d", (int32_T)_SFD_INTEGER_CHECK("i",
      c8_i), 1, 1331, 2, 0) - 1;
    for (c8_i21 = 0; c8_i21 < 3; c8_i21++) {
      c8_b[c8_i21] = c8_d[c8_i21 + 3 * c8_f_i];
    }

    c8_scalarEg(chartInstance);
    for (c8_i22 = 0; c8_i22 < 3; c8_i22++) {
      c8_d_a[c8_i22] = c8_c_a[c8_i22];
    }

    for (c8_i23 = 0; c8_i23 < 3; c8_i23++) {
      c8_c_b[c8_i23] = c8_b[c8_i23];
    }

    c8_didi = c8_eml_xdotu(chartInstance, c8_d_a, c8_c_b);
    _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 11);
    c8_j = 1.0;
    c8_b_j = 0;
    while (c8_b_j < 6) {
      c8_j = 1.0 + (real_T)c8_b_j;
      CV_EML_FOR(0, 1, 1, 1);
      _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 12);
      c8_A = (c8_j - 1.0) * 3.1415926535897931;
      c8_x = c8_A;
      c8_b_x = c8_x;
      c8_c_x = c8_b_x;
      c8_b_y = c8_c_x / 3.0;
      ...
      c8_b_A = (c8_j - 1.0) * 3.1415926535897931;
      c8_f_x = c8_b_A;
      c8_g_x = c8_f_x;
      c8_h_x = c8_g_x;
      c8_c_y = c8_h_x / 3.0;
      ...
      c8_dist[(_SFD_EML_ARRAY_BOUNDS_CHECK("dist", (int32_T)_SFD_INTEGER_CHECK(
                 "j", c8_j), 1, 6, 1, 0) + 6 * (_SFD_EML_ARRAY_BOUNDS_CHECK(
                 "dist", (int32_T)_SFD_INTEGER_CHECK("i", c8_i), 1, 1331, 2, 0)
                - 1)) - 1] = c8_e_x * c8_d[3 * (_SFD_EML_ARRAY_BOUNDS_CHECK("d",
        (int32_T)_SFD_INTEGER_CHECK("i", c8_i), 1, 1331, 2, 0) - 1)] - c8_j_x *
        c8_d[1 + 3 * (_SFD_EML_ARRAY_BOUNDS_CHECK("d", (int32_T)
        _SFD_INTEGER_CHECK("i", c8_i), 1, 1331, 2, 0) - 1)];
      _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 13);
      c8_b0 = (c8_dist[(_SFD_EML_ARRAY_BOUNDS_CHECK("dist", (int32_T)
                 _SFD_INTEGER_CHECK("j", c8_j), 1, 6, 1, 0) + 6 *
                        (_SFD_EML_ARRAY_BOUNDS_CHECK("dist", (int32_T)
                  _SFD_INTEGER_CHECK("i", c8_i), 1, 1331, 2, 0) - 1)) - 1] >=
               0.0);
      c8_b1 = (c8_dist[(_SFD_EML_ARRAY_BOUNDS_CHECK("dist", (int32_T)
                 _SFD_INTEGER_CHECK("j", c8_j), 1, 6, 1, 0) + 6 *
                        (_SFD_EML_ARRAY_BOUNDS_CHECK("dist", (int32_T)
                  _SFD_INTEGER_CHECK("i", c8_i), 1, 1331, 2, 0) - 1)) - 1] <=
               c8_h);
      if (CV_EML_IF(0, 1, 0, c8_b0 && c8_b1)) {
        _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 14);
        c8_c_A = (c8_h - c8_dist[(_SFD_EML_ARRAY_BOUNDS_CHECK("dist", (int32_T)
                    _SFD_INTEGER_CHECK("j", c8_j), 1, 6, 1, 0) + 6 *
                   (_SFD_EML_ARRAY_BOUNDS_CHECK("dist", (int32_T)
          _SFD_INTEGER_CHECK("i", c8_i), 1, 1331, 2, 0) - 1)) - 1]) * c8_rho;
        c8_B = c8_h;
        c8_k_x = c8_c_A;
        c8_d_y = c8_B;
        c8_l_x = c8_k_x;
        ...
        c8_m_x = c8_l_x;
        c8_f_y = c8_e_y;
        c8_g_y = c8_m_x / c8_f_y;
        if (CV_EML_IF(0, 1, 1, (c8_didi - c8_mpower(chartInstance, c8_dist
               [(_SFD_EML_ARRAY_BOUNDS_CHECK("dist", (int32_T)_SFD_INTEGER_CHECK
                 ("j", c8_j), 1, 6, 1, 0) + 6 * (_SFD_EML_ARRAY_BOUNDS_CHECK(
                  "dist", (int32_T)_SFD_INTEGER_CHECK("i", c8_i), 1, 1331, 2, 0)
                 - 1)) - 1])) - c8_mpower(chartInstance, c8_g_y) >= 0.0)) {
          _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 15);
          c8_dist[(_SFD_EML_ARRAY_BOUNDS_CHECK("dist", (int32_T)
                    _SFD_INTEGER_CHECK("j", c8_j), 1, 6, 1, 0) + 6 *
                   (_SFD_EML_ARRAY_BOUNDS_CHECK("dist", (int32_T)
                     _SFD_INTEGER_CHECK("i", c8_i), 1, 1331, 2, 0) - 1)) - 1] =
            rtInf;
  ...
  c8_g_i = 0;
  while (c8_g_i < 6) {
    c8_i = 1.0 + (real_T)c8_g_i;
    CV_EML_FOR(0, 1, 2, 1);
    _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 23);
    c8_h_i = _SFD_EML_ARRAY_BOUNDS_CHECK("dist", (int32_T)_SFD_INTEGER_CHECK("i",
      c8_i), 1, 6, 1, 0) - 1;
    for (c8_i24 = 0; c8_i24 < 1331; c8_i24++) {
      c8_varargin_1[c8_i24] = c8_dist[c8_h_i + 6 * c8_i24];
    }

    c8_ixstart = 1;
    c8_mtmp = c8_varargin_1[0];
    c8_n_x = c8_mtmp;
    c8_d_b = muDoubleScalarIsNaN(c8_n_x);
    if (c8_d_b) {
      c8_ix = 2;
      exitg1 = false;
      while ((exitg1 == false) && (c8_ix < 1332)) {
        c8_b_ix = c8_ix;
        c8_ixstart = c8_b_ix;
        c8_o_x = c8_varargin_1[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", (real_T)c8_b_ix), 1, 1331, 1, 0) - 1];
        c8_e_b = muDoubleScalarIsNaN(c8_o_x);
        if (!c8_e_b) {
    ...
    if (c8_ixstart < 1331) {
      ...
      for (c8_c_ix = c8_i25 + 1; c8_c_ix < 1332; c8_c_ix++) {
        c8_b_ix = c8_c_ix;
        c8_g_a = c8_varargin_1[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", (real_T)c8_b_ix), 1, 1331, 1, 0) - 1];
        c8_f_b = c8_mtmp;
        c8_p = (c8_g_a < c8_f_b);
        if (c8_p) {
    ...
    c8_b_mtmp = c8_mtmp;
    c8_minval = c8_b_mtmp;
    c8_dist_out[_SFD_EML_ARRAY_BOUNDS_CHECK("dist_out", (int32_T)
      _SFD_INTEGER_CHECK("i", c8_i), 1, 6, 1, 0) - 1] = c8_minval;
    c8_g_i++;
    _SF_MEX_LISTEN_FOR_CTRL_C(chartInstance->S);
  }
  ...
  for (c8_i26 = 0; c8_i26 < 6; c8_i26++) {
    (*c8_b_dist_out)[c8_i26] = c8_dist_out[c8_i26];
  }
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  for (c8_i27 = 0; c8_i27 < 6; c8_i27++) {
    c8_b_inData[c8_i27] = (*(real_T (*)[6])c8_inData)[c8_i27];
  }

  for (c8_i28 = 0; c8_i28 < 6; c8_i28++) {
    c8_u[c8_i28] = c8_b_inData[c8_i28];
  }
  ...
  const mxArray *c8_dist_out, const char_T *c8_identifier, real_T c8_y[6])
{
  ...
  c8_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c8_dist_out), &c8_thisId, c8_y);
  sf_mex_destroy(&c8_dist_out);
}
  ...
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData)
{
  ...
  SFc8_hexacopterInstanceStruct *chartInstance;
  chartInstance = (SFc8_hexacopterInstanceStruct *)chartInstanceVoid;
  c8_dist_out = sf_mex_dup(c8_mxArrayInData);
  ...
  for (c8_i30 = 0; c8_i30 < 6; c8_i30++) {
    (*(real_T (*)[6])c8_outData)[c8_i30] = c8_y[c8_i30];
  }
  ...
  *c8_inData)
{
  ...
  chartInstance = (SFc8_hexacopterInstanceStruct *)chartInstanceVoid;
  c8_mxArrayOutData = NULL;
  for (c8_i31 = 0; c8_i31 < 2; c8_i31++) {
    c8_b_inData[c8_i31] = (*(real_T (*)[2])c8_inData)[c8_i31];
  }
  ...
  *c8_inData)
{
  ...
  for (c8_i34 = 0; c8_i34 < 3; c8_i34++) {
    for (c8_i35 = 0; c8_i35 < 3; c8_i35++) {
      c8_b_inData[c8_i35 + c8_i33] = (*(real_T (*)[9])c8_inData)[c8_i35 + c8_i33];
    }
  ...
  for (c8_i37 = 0; c8_i37 < 3; c8_i37++) {
    for (c8_i38 = 0; c8_i38 < 3; c8_i38++) {
      c8_u[c8_i38 + c8_i36] = c8_b_inData[c8_i38 + c8_i36];
    }
  ...
  *c8_inData)
{
  ...
  for (c8_i39 = 0; c8_i39 < 3; c8_i39++) {
    c8_b_inData[c8_i39] = (*(real_T (*)[3])c8_inData)[c8_i39];
  }
  ...
  *c8_inData)
{
  ...
  c8_mxArrayOutData = NULL;
  c8_i41 = 0;
  for (c8_i42 = 0; c8_i42 < 1331; c8_i42++) {
    for (c8_i43 = 0; c8_i43 < 3; c8_i43++) {
      c8_b_inData[c8_i43 + c8_i41] = (*(real_T (*)[3993])c8_inData)[c8_i43 +
        c8_i41];
    }
  ...
  c8_i44 = 0;
  for (c8_i45 = 0; c8_i45 < 1331; c8_i45++) {
    for (c8_i46 = 0; c8_i46 < 3; c8_i46++) {
      c8_u[c8_i46 + c8_i44] = c8_b_inData[c8_i46 + c8_i44];
    }
  ...
  *c8_inData)
{
  ...
  c8_mxArrayOutData = NULL;
  c8_i47 = 0;
  for (c8_i48 = 0; c8_i48 < 1331; c8_i48++) {
    for (c8_i49 = 0; c8_i49 < 6; c8_i49++) {
      c8_b_inData[c8_i49 + c8_i47] = (*(real_T (*)[7986])c8_inData)[c8_i49 +
        c8_i47];
    }
  ...
  c8_i50 = 0;
  for (c8_i51 = 0; c8_i51 < 1331; c8_i51++) {
    for (c8_i52 = 0; c8_i52 < 6; c8_i52++) {
      c8_u[c8_i52 + c8_i50] = c8_b_inData[c8_i52 + c8_i50];
    }
  ...
  c8_y = NULL;
  sf_mex_assign(&c8_y, sf_mex_create("y", c8_u, 0, 0U, 1U, 0U, 2, 6, 1331),
                false);
  sf_mex_assign(&c8_mxArrayOutData, c8_y, false);
  return c8_mxArrayOutData;
}
  ...
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[7986])
{
  ...
  int32_T c8_i53;
  (void)chartInstance;
  sf_mex_import(c8_parentId, sf_mex_dup(c8_u), c8_dv2, 1, 0, 0U, 1, 0U, 2, 6,
                1331);
  for (c8_i53 = 0; c8_i53 < 7986; c8_i53++) {
    c8_y[c8_i53] = c8_dv2[c8_i53];
  }
  ...
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData)
{
  ...
  SFc8_hexacopterInstanceStruct *chartInstance;
  chartInstance = (SFc8_hexacopterInstanceStruct *)chartInstanceVoid;
  c8_dist = sf_mex_dup(c8_mxArrayInData);
  c8_identifier = c8_varName;
  c8_thisId.fIdentifier = c8_identifier;
  c8_thisId.fParent = NULL;
  c8_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c8_dist), &c8_thisId, c8_y);
  sf_mex_destroy(&c8_dist);
  c8_i54 = 0;
  for (c8_i55 = 0; c8_i55 < 1331; c8_i55++) {
    for (c8_i56 = 0; c8_i56 < 6; c8_i56++) {
      (*(real_T (*)[7986])c8_outData)[c8_i56 + c8_i54] = c8_y[c8_i56 + c8_i54];
    }
  ...
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[3993])
{
  ...
  int32_T c8_i57;
  (void)chartInstance;
  sf_mex_import(c8_parentId, sf_mex_dup(c8_u), c8_dv3, 1, 0, 0U, 1, 0U, 2, 3,
                1331);
  for (c8_i57 = 0; c8_i57 < 3993; c8_i57++) {
    c8_y[c8_i57] = c8_dv3[c8_i57];
  }
  ...
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData)
{
  ...
  SFc8_hexacopterInstanceStruct *chartInstance;
  chartInstance = (SFc8_hexacopterInstanceStruct *)chartInstanceVoid;
  c8_d = sf_mex_dup(c8_mxArrayInData);
  c8_identifier = c8_varName;
  c8_thisId.fIdentifier = c8_identifier;
  c8_thisId.fParent = NULL;
  c8_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c8_d), &c8_thisId, c8_y);
  sf_mex_destroy(&c8_d);
  c8_i58 = 0;
  for (c8_i59 = 0; c8_i59 < 1331; c8_i59++) {
    for (c8_i60 = 0; c8_i60 < 3; c8_i60++) {
      (*(real_T (*)[3993])c8_outData)[c8_i60 + c8_i58] = c8_y[c8_i60 + c8_i58];
    }
...
const mxArray *sf_c8_hexacopter_get_eml_resolved_functions_info(void)
{
  ...
  sf_mex_assign(&c8_nameCaptureInfo, sf_mex_createstruct("structure", 2, 65, 1),
                false);
...
static void c8_info_helper(const mxArray **c8_info)
{
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/eml_mtimes_helper.m"),
                  "context", "context", 14);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("eml_xdotu"), "name", "name",
                  14);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 14);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("mrdivide"), "name", "name", 29);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 29);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 31);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("rdivide"), "name", "name", 31);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 31);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 34);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("eml_div"), "name", "name", 34);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 34);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, sf_mex_duplicatearraysafe(&c8_lhs35), "lhs", "lhs",
                  35);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(""), "context", "context", 36);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("cos"), "name", "name", 36);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 36);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m"), "resolved",
                  "resolved", 36);
  sf_mex_addfield(*c8_info, c8_b_emlrt_marshallOut(1343837572U), "fileTimeLo",
                  "fileTimeLo", 36);
  sf_mex_addfield(*c8_info, c8_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 36);
  sf_mex_addfield(*c8_info, c8_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c8_info, c8_b_emlrt_marshallOut(1286825922U), "fileTimeLo",
                  "fileTimeLo", 37);
  sf_mex_addfield(*c8_info, c8_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 37);
  sf_mex_addfield(*c8_info, c8_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("sin"), "name", "name", 38);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 38);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m"), "resolved",
                  "resolved", 38);
  sf_mex_addfield(*c8_info, c8_b_emlrt_marshallOut(1343837586U), "fileTimeLo",
                  "fileTimeLo", 38);
  sf_mex_addfield(*c8_info, c8_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 38);
  sf_mex_addfield(*c8_info, c8_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c8_info, c8_b_emlrt_marshallOut(1286825936U), "fileTimeLo",
                  "fileTimeLo", 39);
  sf_mex_addfield(*c8_info, c8_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 39);
  sf_mex_addfield(*c8_info, c8_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("mpower"), "name", "name", 40);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 40);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 42);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("ismatrix"), "name", "name", 42);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 42);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 43);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("power"), "name", "name", 43);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 43);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m!fltpower"), "context",
                  "context", 48);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("floor"), "name", "name", 48);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 48);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, sf_mex_duplicatearraysafe(&c8_lhs51), "lhs", "lhs",
                  51);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(""), "context", "context", 52);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("min"), "name", "name", 52);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 52);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_const_nonsingleton_dim.m"),
                  "context", "context", 55);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "coder.internal.constNonSingletonDim"), "name", "name", 55);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 55);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m!eml_extremum_sub"),
                  "context", "context", 59);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("isnan"), "name", "name", 59);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 59);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  c8_A[9], real_T c8_B[3], real_T c8_C[3], real_T c8_b_C[3])
{
  ...
  for (c8_i61 = 0; c8_i61 < 3; c8_i61++) {
    c8_b_C[c8_i61] = c8_C[c8_i61];
  }

  for (c8_i62 = 0; c8_i62 < 9; c8_i62++) {
    c8_b_A[c8_i62] = c8_A[c8_i62];
  }

  for (c8_i63 = 0; c8_i63 < 3; c8_i63++) {
    c8_b_B[c8_i63] = c8_B[c8_i63];
  }
  ...
  c8_x[3], real_T c8_y[3])
{
  ...
  for (c8_k = 1; c8_k < 4; c8_k++) {
    ...
    c8_d += c8_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      (real_T)c8_b_k), 1, 3, 1, 0) - 1] * c8_y[_SFD_EML_ARRAY_BOUNDS_CHECK("",
  ...
  *chartInstance, boolean_T c8_overflow)
{
  ...
  if (!c8_overflow) {
    ...
    for (c8_i64 = 0; c8_i64 < 34; c8_i64++) {
      c8_u[c8_i64] = c8_cv0[c8_i64];
    }

    c8_y = NULL;
    sf_mex_assign(&c8_y, sf_mex_create("y", c8_u, 10, 0U, 1U, 0U, 2, 1, 34),
                  false);
    for (c8_i65 = 0; c8_i65 < 23; c8_i65++) {
      c8_b_u[c8_i65] = c8_cv1[c8_i65];
    }
  ...
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId)
{
  ...
  int32_T c8_i66;
  (void)chartInstance;
  sf_mex_import(c8_parentId, sf_mex_dup(c8_u), &c8_i66, 1, 6, 0U, 0, 0U, 0);
  c8_y = c8_i66;
  sf_mex_destroy(&c8_u);
  return c8_y;
}
  ...
  c8_A[9], real_T c8_B[3], real_T c8_C[3])
{
  ...
  for (c8_i67 = 0; c8_i67 < 3; c8_i67++) {
    ...
    for (c8_i69 = 0; c8_i69 < 3; c8_i69++) {
      c8_C[c8_i67] += c8_A[c8_i68 + c8_i67] * c8_B[c8_i69];
      c8_i68 += 3;
    }
  }
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2931041867U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2501596290U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(274137433U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3991225147U);
}
...
mxArray *sf_c8_hexacopter_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("CwXadXbct6prsnYWalTwjF");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,419,457,588,639);
        _SFD_CV_INIT_EML_IF(0,1,1,472,524,-1,577);
        _SFD_CV_INIT_EML_FOR(0,1,0,214,239,658);
        _SFD_CV_INIT_EML_FOR(0,1,1,325,337,650);
        _SFD_CV_INIT_EML_FOR(0,1,2,663,675,720);
...
static void mdlSetWorkWidths_c8_hexacopter(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3347514098U));
  ssSetChecksum1(S,(191226694U));
  ssSetChecksum2(S,(692759947U));
  ssSetChecksum3(S,(4132745354U));
